          ...
          <?php 
            if(!isset($_SESSION['ID_user'])) {
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownAccount">
                <a class="dropdown-item" href="../pages/auth/login.php">Se connecter</a>
                <a class="dropdown-item" href="../pages/auth/register.php">S\'inscrire</a>
              </div>
              ';
            } else {
              print '
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownAccount">
                <a class="dropdown-item" href="../pages/account/dashboard.php">Profile</a>
                <a class="dropdown-item text-danger" href="../pages/auth/logout.php">Deconnexion</a>
              </div>
              ';
            }
          ?>
