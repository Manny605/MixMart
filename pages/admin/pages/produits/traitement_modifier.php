...
if(isset($_POST['id_produit'], $_POST['nom'], $_POST['description'], $_POST['prix'], $_POST['stock'], $_POST['categorie'])) {
    ...
    $sql = "UPDATE produit SET categorie_id = :categorie, Nom = :nom, Description = :description, Prix = :prix, Stock_disponible = :stock, Image = :image WHERE ID_Produit = :id";
    $stmt = $connect->prepare($sql);
    
    // Bind parameters
    $stmt->bindParam(':categorie', $nom, PDO::PARAM_INT);
